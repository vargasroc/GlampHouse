...
CREATE TABLE `activities` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKiyft57aynb659jkja6k2dqfhh` (`cities_id`),
  CONSTRAINT `FKiyft57aynb659jkja6k2dqfhh` FOREIGN KEY (`cities_id`) REFERENCES `city` (`id`)
...
-- Dump completed on 2022-09-23 15:29:12
